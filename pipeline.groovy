node(){
    ...
    stage("deploy"){
        bat """
         curl "http://localhost:8888/repository/maven-public/com/spring-boot/spring-boot/${env.BUILD_NUMBER}/spring-boot-${env.BUILD_NUMBER}.jar" --output spring-boot-1.0.jar
